                        ...
                        <tr v-for="student in students.data" :key="student.id" class="transition-colors hover:bg-muted/30">
                            ...
                            <td class="px-5 py-3.5 text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    <Link v-if="isAdmin" :href="route('student-fees.edit-student', student.id)" class="rounded-lg border border-border bg-card p-1.5 text-muted-foreground transition-all hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700" title="Edit Student Info">
